...
public class KhDistrict : AuditObject
{
    ...
    public KhProvince? Province { get; set; }

	[Computed, Write(false)]
	public List<KhCommune> Communes { get; }

	[Computed, Write(false)]
	public List<KhVillage> Villages { get; }
	#endregion
