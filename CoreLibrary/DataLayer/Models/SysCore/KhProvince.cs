...
public class KhProvince : AuditObject
{
    ...
    public List<KhDistrict> Districts { get; set; }

    [Computed, Write(false)]
    public List<KhCommune> Communes { get; set; }

    [Computed, Write(false)]
    public List<KhVillage> Villages { get; set; }
    #endregion
