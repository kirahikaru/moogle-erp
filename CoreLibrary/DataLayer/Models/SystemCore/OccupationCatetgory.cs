...
public class OccupationCategory : AuditObject
{
	[Computed, ReadOnly(true), Write(false)]
	public new static string MsSqlTableName => typeof(OccupationCategory).Name;

	[Computed, ReadOnly(true), Write(false)]
	public new static string PgTableName => $"occupation_category";
