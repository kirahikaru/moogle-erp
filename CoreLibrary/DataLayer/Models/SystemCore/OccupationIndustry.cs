...
[Table("OccupationIndustry")]
public class OccupationIndustry : AuditObject
{
	[Computed, ReadOnly(true), Write(false)]
	public new static string MsSqlTableName => typeof(OccupationIndustry).Name;

	[Computed, ReadOnly(true), Write(false)]
	public new static string PgTableName => $"occupation_industry";
