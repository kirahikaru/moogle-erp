...
public class EventRegistrationRepos(IConnectionFactory connectionFactory) : BaseRepos<EventRegistration>(connectionFactory, EventRegistration.DatabaseObject), IEventRegistrationRepos
{
