...
public class ExchangeRateRepos(IConnectionFactory connectionFactory) : BaseRepos<ExchangeRate>(connectionFactory, ExchangeRate.DatabaseObject), IExchangeRateRepos
{
