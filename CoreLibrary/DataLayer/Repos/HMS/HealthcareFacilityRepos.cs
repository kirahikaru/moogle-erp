...
public class HealthcareFacilityRepos(IDbContext dbContext) : BaseRepos<HealthcareFacility>(dbContext, HealthcareFacility.DatabaseObject), IHealthcareFacilityRepos
{
