...
public class MedicalExamRepos(IConnectionFactory connectionFactory) : BaseWorkflowEnabledRepos<MedicalExam>(connectionFactory, MedicalExam.DatabaseObject), IMedicalExamRepos
{
