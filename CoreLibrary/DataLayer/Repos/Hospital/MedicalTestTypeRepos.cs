...
public class MedicalTestTypeRepos(IConnectionFactory connectionFactory) : BaseRepos<MedicalTestType>(connectionFactory, MedicalTestType.DatabaseObject), IMedicalTestTypeRepos
{
