...
public class BookPurchaseHistoryRepos(IConnectionFactory connectionFactory) : BaseRepos<BookPurchaseHistory>(connectionFactory, BookPurchaseHistory.DatabaseObject), IBookPurchaseHistoryRepos
{
