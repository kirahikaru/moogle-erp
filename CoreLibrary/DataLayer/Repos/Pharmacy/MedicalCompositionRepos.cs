...
public class MedicalCompositionRepos(IConnectionFactory connectionFactory) : BaseRepos<MedicalComposition>(connectionFactory, MedicalComposition.DatabaseObject), IMedicalCompositionRepos
{
