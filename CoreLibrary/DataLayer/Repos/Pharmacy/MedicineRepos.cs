...
using DataLayer.Models.Pharmacy.NonPersistent;
...
public class MedicineRepos(IConnectionFactory connectionFactory) : BaseRepos<Medicine>(connectionFactory, Medicine.DatabaseObject), IMedicineRepos
{
