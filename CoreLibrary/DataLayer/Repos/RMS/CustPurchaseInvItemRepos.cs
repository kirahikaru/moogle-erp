...
public class CustPurchaseInvItemRepos(IDbContext dbContext) : BaseRepos<CustPurchaseInvItem>(dbContext, CustPurchaseInvItem.DatabaseObject), ICustPurchaseInvItemRepos
{
