...
public class InventoryCheckInItemRepos(IDbContext dbContext) : BaseWorkflowEnabledRepos<InventoryCheckInItem>(dbContext, InventoryCheckInItem.DatabaseObject), IInventoryCheckInItemRepos
{
