...
public class InventoryCheckOutItemRepos(IDbContext dbContext) : BaseRepos<InventoryCheckOutItem>(dbContext, InventoryCheckOutItem.DatabaseObject), IInventoryCheckOutItemRepos
{
