...
public class InventoryCheckOutRepos(IDbContext dbContext) : BaseWorkflowEnabledRepos<InventoryCheckOut>(dbContext, InventoryCheckOut.DatabaseObject), IInventoryCheckOutRepos
{
