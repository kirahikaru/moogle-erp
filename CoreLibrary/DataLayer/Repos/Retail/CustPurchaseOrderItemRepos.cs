...
public class CustPurchaseOrderItemRepos(IConnectionFactory connectionFactory) : BaseRepos<CustPurchaseOrderItem>(connectionFactory, CustPurchaseOrderItem.DatabaseObject), ICustomerPurchaseOrderItemRepos
{
