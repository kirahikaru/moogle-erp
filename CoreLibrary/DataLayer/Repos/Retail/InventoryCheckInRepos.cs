...
public class InventoryCheckInRepos(IConnectionFactory connectionFactory) : BaseWorkflowEnabledRepos<InventoryCheckIn>(connectionFactory, InventoryCheckIn.DatabaseObject), IInventoryCheckInRepos
{
