...
public class ItemPriceHistoryRepos(IConnectionFactory connectionFactory) : BaseRepos<ItemPriceHistory>(connectionFactory, ItemPriceHistory.DatabaseObject), IItemPriceHistoryRepos
{
