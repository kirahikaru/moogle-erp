...
public class ItemSupplierRepos(IConnectionFactory connectionFactory) : BaseRepos<ItemSupplier>(connectionFactory, ItemSupplier.DatabaseObject), IItemSupplierRepos
{
