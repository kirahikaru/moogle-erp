...
public class ItemVariationRepos(IConnectionFactory connectionFactory) : BaseRepos<ItemVariation>(connectionFactory, ItemVariation.DatabaseObject), IItemVariationRepos
{
