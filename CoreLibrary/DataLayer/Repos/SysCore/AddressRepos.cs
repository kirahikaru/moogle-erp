...
public class AddressRepos(IDbContext dbContext) : BaseRepos<Address>(dbContext, new DatabaseObj(AuditObject.SchemaName, Address.MsSqlTableName, Address.PgTableName)), IAddressRepos
{
