...
public class CambodiaDistrictRepos(IDbContext dbContext) : BaseRepos<CambodiaDistrict>(dbContext, CambodiaDistrict.DatabaseObject), ICambodiaDistrictRepos
{
	...
	public override async Task<KeyValuePair<int, IEnumerable<CambodiaDistrict>>> SearchNewAsync(
