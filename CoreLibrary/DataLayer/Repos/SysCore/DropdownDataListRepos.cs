...
public class DropdownDataListRepos(IDbContext dbContext) : BaseRepos<DropdownDataList>(dbContext, DropdownDataList.DatabaseObject), IDropdownDataListRepos
{
	...
	public override async Task<KeyValuePair<int, IEnumerable<DropdownDataList>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<DropdownDataList>(sql, param);
