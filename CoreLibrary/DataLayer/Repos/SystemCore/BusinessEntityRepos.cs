...
public class BusinessEntityRepos(IConnectionFactory connectionFactory) : BaseRepos<BusinessEntity>(connectionFactory, BusinessEntity.DatabaseObject), IBusinessEntityRepos
{
