...
public class CambodiaCommuneRepos(IConnectionFactory connectionFactory) : BaseRepos<CambodiaCommune>(connectionFactory, CambodiaCommune.DatabaseObject), ICambodiaCommuneRepos
{
