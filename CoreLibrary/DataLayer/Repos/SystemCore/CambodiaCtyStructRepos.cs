...
public class CambodiaCtyStructRepos(IConnectionFactory connectionFactory) : BaseRepos<CambodiaCountryStructure>(connectionFactory, CambodiaCountryStructure.DatabaseObject), ICambodiaCtyStructRepos
{
