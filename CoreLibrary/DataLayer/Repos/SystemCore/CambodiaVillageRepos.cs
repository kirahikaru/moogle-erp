...
public class CambodiaVillageRepos(IConnectionFactory connectionFactory) : BaseRepos<CambodiaVillage>(connectionFactory, CambodiaVillage.DatabaseObject), ICambodiaVillageRepos
{
