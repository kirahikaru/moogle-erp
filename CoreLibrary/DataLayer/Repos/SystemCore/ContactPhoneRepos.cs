...
public class ContactPhoneRepos(IConnectionFactory connectionFactory) : BaseRepos<ContactPhone>(connectionFactory, ContactPhone.DatabaseObject), IContactPhoneRepos
{
