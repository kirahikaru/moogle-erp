...
public class OccupationIndustryRepos(IConnectionFactory connectionFactory) : BaseRepos<OccupationIndustry>(connectionFactory, OccupationIndustry.DatabaseObject), IOccupationIndustryRepos
{
