...
public class OrgBranchRepos(IConnectionFactory connectionFactory) : BaseRepos<OrganizationBranch>(connectionFactory, OrganizationBranch.DatabaseObject), IOrgBranchRepos
{
