...
public class ProductCategoryRepos(IConnectionFactory connectionFactory) : BaseRepos<ProductCategory>(connectionFactory, ProductCategory.DatabaseObject), IProductCategoryRepos
{
