...
public class RunNumGeneratorRepos(IConnectionFactory connectionFactory) : BaseRepos<RunNumGenerator>(connectionFactory, RunNumGenerator.DatabaseObject), IRunNumGeneratorRepos
{
