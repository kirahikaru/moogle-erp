...
public class TermAndConditionRepos(IConnectionFactory connectionFactory) : BaseRepos<TermAndCondition>(connectionFactory, TermAndCondition.DatabaseObject), ITermAndConditionRepos
{
