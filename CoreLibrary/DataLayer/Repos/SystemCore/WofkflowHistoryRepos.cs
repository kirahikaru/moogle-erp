...
public class WorkflowHistoryRepos(IConnectionFactory connectionFactory) : BaseRepos<WorkflowHistory>(connectionFactory, WorkflowHistory.DatabaseObject), IWorkflowHistoryRepos
{
