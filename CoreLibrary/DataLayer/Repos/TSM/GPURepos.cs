...
public interface IGPURepos : IBaseRepos<GPU>
{
	
}

public class GPURepos(IDbContext dbContext) : BaseRepos<GPU>(dbContext, GPU.DatabaseObject), IGPURepos
{
	public override async Task<KeyValuePair<int, IEnumerable<GPU>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<GPU>(sql, param);
