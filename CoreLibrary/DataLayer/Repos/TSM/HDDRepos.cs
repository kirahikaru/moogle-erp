...
public interface IHDDRepos : IBaseRepos<HDD>
{
	
}

public class HDDRepos(IDbContext dbContext) : BaseRepos<HDD>(dbContext, HDD.DatabaseObject), IHDDRepos
{
	public override async Task<KeyValuePair<int, IEnumerable<HDD>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<HDD>(sql, param);
