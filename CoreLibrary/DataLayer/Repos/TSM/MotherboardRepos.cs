...
public interface IMotherboardRepos : IBaseRepos<Motherboard>
{
	
}

public class MotherboardRepos(IDbContext dbContext) : BaseRepos<Motherboard>(dbContext, Motherboard.DatabaseObject), IMotherboardRepos
{
	public override async Task<KeyValuePair<int, IEnumerable<Motherboard>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<Motherboard>(sql, param);
