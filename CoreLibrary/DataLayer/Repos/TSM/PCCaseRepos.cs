...
public interface IPCCaseRepos : IBaseRepos<PCCase>
{
	
}

public class PCCaseRepos(IDbContext dbContext) : BaseRepos<PCCase>(dbContext, PCCase.DatabaseObject), IPCCaseRepos
{
	public override async Task<KeyValuePair<int, IEnumerable<PCCase>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<PCCase>(sql, param);
