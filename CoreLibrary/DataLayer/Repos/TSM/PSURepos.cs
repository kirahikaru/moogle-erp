...
public interface IPSURepos : IBaseRepos<PSU>
{
	
}

public class PSURepos(IDbContext dbContext) : BaseRepos<PSU>(dbContext, PSU.DatabaseObject), IPSURepos
{
	public override async Task<KeyValuePair<int, IEnumerable<PSU>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<PSU>(sql, param);
