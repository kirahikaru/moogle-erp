...
public interface IRAMRepos : IBaseRepos<RAM>
{
	
}

public class RAMRepos(IDbContext dbContext) : BaseRepos<RAM>(dbContext, RAM.DatabaseObject), IRAMRepos
{
	public override async Task<KeyValuePair<int, IEnumerable<RAM>>> SearchNewAsync(
		...
		List<int>? excludeIdList = null)
	{
		...
		var dataList = await cn.QueryAsync<RAM>(sql, param);
