...
public interface IUowMoogleKhErp : IUnitOfWork
{
	...
	/// <summary>
	/// Customer Purchase Invoice Items
	/// </summary>
...
{
    public UowMoogleKhErp(IOptionsMonitor<DatabaseConfig> dbConfigs, string databaseType = DatabaseTypes.MSSQL) : base(dbConfigs, "MoogleKhErp", databaseType)
    {
        #region EMS - Event Management System
